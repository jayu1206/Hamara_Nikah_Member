...
public class memberMaintenance {
	...
	public ErrorMsg newRegistration(HttpServletRequest request) {
		...
		if(!request.getParameter("maritalStatus").equalsIgnoreCase("Single") &&
				!request.getParameter("maritalStatus").equalsIgnoreCase("Married") &&
				!request.getParameter("maritalStatus").equalsIgnoreCase("Widowed") &&
				!request.getParameter("maritalStatus").equalsIgnoreCase("Divorced") ){
			return new ErrorMsg(1, "maritalStatus is not valid");
			
		}
		bean.setMaritalStatus(request.getParameter("maritalStatus"));
	...
	public void seachMember(HttpServletRequest request) {
		...
		request.setAttribute(contentPage.MEMBERSEARCH, list);
