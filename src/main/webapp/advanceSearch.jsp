...
<html lang="en">
    <head>
		...
		<script src='js/softnice.js?v=hnjnhg"+ Date.now() + "' type="text/javascript" charset="utf-8"></script>
            ...
            <div class="main-header">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="login-form" style="width: 130%;">
                                ...
                                <input type="hidden" id="key" name="key" value="" />
                                    ...
                                    <input type="submit" class="btn" value="login" id="btnSubmit"  name="btnSubmit" style="background-color: #5e1914!important; border-color: #5e1914;border: solid 1px #e4d7d2;" />
                                </form>
                            </div>
                        </div>
                        <% }else{%>
...
<%--         <section class="recently-joined-section">
								...
								<h2>Search members....</h2>
  								...
  								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									<tbody>
									                ...
									                <%for(int kk=1 ; kk<=10 ; kk++){   i = 1; for(memberBean bean2 : memberList){ %>
									                	<%if(i==1){ %><tr>  <%} %>
									                			<td align="center" >
											                    <div class="col-md-6 col-lg-4">
											                        <div class="joined-block">
											                            <div class="joined-member-image">
											                                ...
											                                <h4><%=bean2.getFirstName() +" "+bean2.getLastName() %></h4>
											                            </div>
											                            <div class="joined-member-info">
											                                <h3><%=bean2.getFirstName() +" "+bean2.getLastName() %></h3>
											                                <p>Age:<%=bean2.getAge() %></p>
											                                <p>City: <%=bean2.getCityName() %></p>
											                                <a href="javascrupt:;" class="btn" style="background-color: #5e1914!important; border-color: #5e1914;" >contact me</a>
											                            </div>
											                        </div>
											                    </div>
											                     </td>
 ...
 --%>
	      ...
	      <!--   <form action="contentMemberServlet?key=message" method="post"  class="partner-form" name="memberForm4" id="memberForm4"> -->
	         ...
	         <section class="recently-joined-section">
	            <div class="container">
	                ...
	                <% for(memberBean bean2 : memberList){ %>
	                    <div class="col-md-6 col-lg-4">
	                        ...
	                        <div class="joined-block">
	                            ...
	                            <div class="joined-member-info">
	                                ...
	                                <p>Age:<%=bean2.getAge() %></p>
	                                <p>City: <%=bean2.getCityName() %></p>
	                                <a href="javascrupt:;" class="btn" id="bootbox-options<%=bean2.getId() %>" onclick="setMemberId(<%=bean2.getId() %>);" style="background-color: #5e1914!important; border-color: #5e1914;" data-target="#myModal" >contact me</a>
	                            </div>
	                        </div>
	                    </div>
	                    <%} %>
...
$(document).ready(function($){
	 ...
	 <% for(memberBean bean2 : memberList){ %>
	 $("#bootbox-options<%=bean2.getId() %>").on(ace.click_event, function() {
		 	if($('#fromMemberId').val()!='0'){
		 		bootbox.dialog({
					...
					buttons:
					{
						...
						"success" :
						 {
							"label" : " Interested!",  // <i class='ace-icon fa fa-check'></i>
							"className" : "btn-sm btn-success",
							"callback": function() {
								
									var str =	sendInterested($('#toMemberId').val(),$('#fromMemberId').val());
									bootbox.dialog({message: "<span class='bigger-110'>Done</span>",
										buttons:
										{
											"success" :
											 {
		 		...
		 		bootbox.dialog({message: "<span class='bigger-110'>Please login first</span>",
					buttons:
					{
						"success" :
						 {
